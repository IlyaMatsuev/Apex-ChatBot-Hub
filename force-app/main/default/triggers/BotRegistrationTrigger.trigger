...
trigger BotRegistrationTrigger on Bot_Registration__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ITriggerHandler registrationHandler = new BotRegistrationHandler();
    TriggerDispatcher.dispatcher
            .bind(TriggerOperation.BEFORE_INSERT, new BotRegistrationValidationHandler())
